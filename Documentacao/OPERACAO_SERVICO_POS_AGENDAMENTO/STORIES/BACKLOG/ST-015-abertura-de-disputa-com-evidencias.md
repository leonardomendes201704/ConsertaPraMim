...
- [ ] Definir tipos de disputa e taxonomia de motivos.
- [ ] Criar entidade `DisputeCase` com SLA, prioridade e ownership.
- [ ] Criar endpoint de abertura de disputa por cliente/prestador.
