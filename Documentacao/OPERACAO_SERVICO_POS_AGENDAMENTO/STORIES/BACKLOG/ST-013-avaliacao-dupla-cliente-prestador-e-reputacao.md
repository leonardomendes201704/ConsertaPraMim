...
- [ ] Evoluir modelo de review para suportar avaliacao bilateral.
- [ ] Criar endpoints separados para avaliacao de cliente e prestador.
- [ ] Implementar regras de elegibilidade e janela de avaliacao.
