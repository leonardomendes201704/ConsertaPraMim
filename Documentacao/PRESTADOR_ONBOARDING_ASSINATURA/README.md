# Prestador Onboarding com Assinatura e Documentos

Este diretorio centraliza o planejamento da evolucao de cadastro do prestador com:

- escolha de plano de assinatura;
- wizard guiado de onboarding;
- envio de documentos de identificacao para validacao.
