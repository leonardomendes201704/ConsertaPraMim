...
- [x] Integrar opcionalmente medidores nativos (`System.Diagnostics.Metrics`) para exportadores externos.sctr
- [x] Implementar area "Monitoramento" no portal admin cem uom cards, graficos, tabelas, paginacao e drilldown.
