...
public interface IReviewService
{
    ...
    Task<ReviewSubmissionResultDto> SubmitClientReviewDetailedAsync(Guid clientId, CreateReviewDto dto);
    Task<ReviewSubmissionResultDto> SubmitProviderReviewDetailedAsync(Guid providerId, CreateReviewDto dto);
