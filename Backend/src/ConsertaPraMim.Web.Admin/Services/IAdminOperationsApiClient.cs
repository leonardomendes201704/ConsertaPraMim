...
public interface IAdminOperationsApiClient
{
    ...
    Task<AdminApiResult<AdminGrowthExecutiveCockpitDto>> GetGrowthExecutiveCockpitAsync(
    ...
    Task<AdminApiResult<AdminGrowthMonthlyReviewSnapshotDto>> GetGrowthMonthlyReviewAsync(
        DateTime? referenceMonthUtc,
        string accessToken,
        CancellationToken cancellationToken = default);

    Task<AdminApiResult<AdminGrowthMonthlyReviewRecordDto>> RecordGrowthMonthlyReviewAsync(
    ...
    Task<AdminApiResult<AdminGrowthAiCompareResultDto>> CompareGrowthAiAnalysesAsync(
