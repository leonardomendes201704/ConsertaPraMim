...
namespace ConsertaPraMim.Infrastructure.Migrations
{
    ...
    [Migration("20260310153442_SyncPendingModelChangesAfterDeployVpsRefactor")]
    partial class SyncPendingModelChangesAfterDeployVpsRefactor
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ConsertaPraMim.Domain.Entities.AdminLoadTestRun", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<double>("P50LatencyMs")
                        .HasColumnType("float");
                    ...
                    b.Property<string>("RawReportJson")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<double>("RpsAvg")
                        .HasColumnType("float");

                    b.Property<int>("RpsPeak")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("Scenario", "StartedAtUtc");

                    b.ToTable("AdminLoadTestRuns", t =>
                        {
            ...
            modelBuilder.Entity("ConsertaPraMim.Domain.Entities.ApiEndpointMetricDaily", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<DateTime>("BucketDateUtc")
                        .HasColumnType("datetime2");
                    ...
                    b.HasIndex("EndpointTemplate", "Method", "BucketDateUtc");

                    b.HasIndex("BucketDateUtc", "Method", "EndpointTemplate", "StatusCode", "Severity", "TenantId")
                        .IsUnique();

                    b.ToTable("ApiEndpointMetricsDaily", t =>
                        {
            ...
            modelBuilder.Entity("ConsertaPraMim.Domain.Entities.ApiEndpointMetricHourly", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("EndpointTemplate", "Method", "BucketStartUtc");

                    b.HasIndex("BucketStartUtc", "Method", "EndpointTemplate", "StatusCode", "Severity", "TenantId")
                        .IsUnique();

                    b.ToTable("ApiEndpointMetricsHourly", t =>
                        {
            ...
            modelBuilder.Entity("ConsertaPraMim.Domain.Entities.ApiErrorCatalog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ApiErrorCatalog");
                });

            modelBuilder.Entity("ConsertaPraMim.Domain.Entities.ApiErrorOccurrenceHourly", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("ErrorCatalogId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ErrorCatalogId");

                    b.HasIndex("EndpointTemplate", "Method", "BucketStartUtc");

                    b.HasIndex("BucketStartUtc", "ErrorCatalogId", "Method", "EndpointTemplate", "StatusCode", "Severity", "TenantId")
                        .IsUnique();

                    b.ToTable("ApiErrorOccurrencesHourly", t =>
                        {
                            t.HasCheckConstraint("CK_ApiErrorOccurrenceHourly_OccurrenceCount_NonNegative", "[OccurrenceCount] >= 0");
                        });
                });

            modelBuilder.Entity("ConsertaPraMim.Domain.Entities.ApiRequestLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("NormalizedErrorKey")
                        .HasMaxLength(160)
                        .HasColumnType("nvarchar(160)");

                    b.Property<string>("NormalizedErrorMessage")
                        .HasMaxLength(1600)
                        .HasColumnType("nvarchar(1600)");
                    ...
                    b.HasIndex("NormalizedErrorKey", "TimestampUtc");

                    b.HasIndex("Severity", "TimestampUtc");

                    b.HasIndex("StatusCode", "TimestampUtc");

                    b.HasIndex("TenantId", "TimestampUtc");

                    b.HasIndex("UserId", "TimestampUtc");

                    b.HasIndex("EndpointTemplate", "Method", "TimestampUtc");

                    b.ToTable("ApiRequestLogs", t =>
                        {
            ...
            modelBuilder.Entity("ConsertaPraMim.Domain.Entities.LegalTermsDocument", b =>
                {
                    ...
                    b.HasIndex("Audience", "IsPublished", "PublishedAtUtc");

                    b.ToTable("LegalTermsDocuments", t =>
                        {
            ...
            modelBuilder.Entity("ConsertaPraMim.Domain.Entities.MobilePushDevice", b =>
                {
                    ...
                    b.HasIndex("AppKind", "InstallationId")
                        .IsUnique();
            ...
            modelBuilder.Entity("ConsertaPraMim.Domain.Entities.Proposal", b =>
                {
                    ...
                    b.Property<int?>("EstimatedLeadTimeHours")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ConsertaPraMim.Domain.Entities.ProposalComparisonInteraction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ClientUserId", "RequestId", "CreatedAt");

                    b.HasIndex("ExperimentGroup", "EventType", "CreatedAt");

                    b.ToTable("ProposalComparisonInteractions");
                });
            ...
            modelBuilder.Entity("ConsertaPraMim.Domain.Entities.ProviderProfile", b =>
                {
                    ...
                    b.Property<int>("ClientPreference")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(0);
            ...
            modelBuilder.Entity("ConsertaPraMim.Domain.Entities.Review", b =>
                {
                    ...
                    b.Property<int?>("CostBenefitRating")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ConsertaPraMim.Domain.Entities.ServiceRequest", b =>
                {
                    ...
                    b.Property<string>("ProblemAnalysisHighlightsJson")
                        .HasMaxLength(4000)
                        .HasColumnType("nvarchar(4000)");

                    b.Property<string>("ProblemAnalysisSummary")
                        .HasMaxLength(1000)
                        .HasColumnType("nvarchar(1000)");
            ...
            modelBuilder.Entity("ConsertaPraMim.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<int>("ClientProfileType")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(1);
            ...
            modelBuilder.Entity("ConsertaPraMim.Domain.Entities.UserLegalTermsAcceptance", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("LegalTermsDocumentId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("LegalTermsDocumentId");

                    b.HasIndex("Audience", "TermsVersion", "AcceptedAtUtc");

                    b.HasIndex("UserId", "Audience", "TermsVersion")
                        .IsUnique();

                    b.ToTable("UserLegalTermsAcceptances", t =>
                        {
            ...
            modelBuilder.Entity("ConsertaPraMim.Domain.Entities.ApiErrorOccurrenceHourly", b =>
                {
                    b.HasOne("ConsertaPraMim.Domain.Entities.ApiErrorCatalog", "ErrorCatalog")
                        .WithMany()
                        .HasForeignKey("ErrorCatalogId")
            ...
            modelBuilder.Entity("ConsertaPraMim.Domain.Entities.UserLegalTermsAcceptance", b =>
                {
                    b.HasOne("ConsertaPraMim.Domain.Entities.LegalTermsDocument", "LegalTermsDocument")
                        .WithMany("Acceptances")
                        .HasForeignKey("LegalTermsDocumentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ConsertaPraMim.Domain.Entities.User", "User")
                        .WithMany("LegalTermsAcceptances")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("LegalTermsDocument");
            ...
            modelBuilder.Entity("ConsertaPraMim.Domain.Entities.User", b =>
                {
                    b.Navigation("LegalTermsAcceptances");
