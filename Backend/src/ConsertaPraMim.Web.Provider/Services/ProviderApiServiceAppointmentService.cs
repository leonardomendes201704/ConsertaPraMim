...
public class ProviderApiServiceAppointmentService : IServiceAppointmentService
{
    private readonly ProviderApiCaller _apiCaller;

    public ProviderApiServiceAppointmentService(ProviderApiCaller apiCaller)
    {
    ...
    public Task<ServiceAppointmentOperationResultDto> OverrideFinancialPolicyAsync(
        ...
        Task.FromResult(new ServiceAppointmentOperationResultDto(false, null, "not_supported", "Operacao nao suportada no portal prestador."));
    ...
    public Task<ServiceScopeChangeRequestOperationResultDto> CreateScopeChangeRequestAsync(
        ...
        Task.FromResult(new ServiceScopeChangeRequestOperationResultDto(false, null, "not_supported", "Operacao nao suportada no portal prestador."));
    ...
    public Task<ServiceWarrantyClaimOperationResultDto> CreateWarrantyClaimAsync(
        ...
        Task.FromResult(new ServiceWarrantyClaimOperationResultDto(false, null, "not_supported", "Operacao nao suportada no portal prestador."));
    ...
    public Task<ServiceDisputeCaseOperationResultDto> CreateDisputeCaseAsync(
        ...
        Task.FromResult(new ServiceDisputeCaseOperationResultDto(false, null, "not_supported", "Operacao nao suportada no portal prestador."));
    ...
    public Task<ServiceWarrantyRevisitOperationResultDto> ScheduleWarrantyRevisitAsync(
        ...
        Task.FromResult(new ServiceWarrantyRevisitOperationResultDto(false, null, null, "not_supported", "Operacao nao suportada no portal prestador."));
    ...
    public Task<ServiceScopeChangeAttachmentOperationResultDto> AddScopeChangeAttachmentAsync(
        ...
        Task.FromResult(new ServiceScopeChangeAttachmentOperationResultDto(false, null, "not_supported", "Operacao nao suportada no portal prestador."));
    ...
    public Task<ServiceDisputeCaseAttachmentOperationResultDto> AddDisputeCaseAttachmentAsync(
        ...
        Task.FromResult(new ServiceDisputeCaseAttachmentOperationResultDto(false, null, "not_supported", "Operacao nao suportada no portal prestador."));
    ...
    public Task<ServiceDisputeCaseMessageOperationResultDto> AddDisputeCaseMessageAsync(
        ...
        Task.FromResult(new ServiceDisputeCaseMessageOperationResultDto(false, null, "not_supported", "Operacao nao suportada no portal prestador."));
    ...
    public Task<ServiceCompletionPinResultDto> GenerateCompletionPinAsync(
        ...
        Task.FromResult(new ServiceCompletionPinResultDto(false, null, null, "not_supported", "Operacao nao suportada no portal prestador."));
