...
public class ClientApiCaller
{
    ...
    private readonly ILogger<ClientApiCaller> _logger;

    public ClientApiCaller(
        IHttpClientFactory httpClientFactory,
        IHttpContextAccessor httpContextAccessor,
        IConfiguration configuration,
        ILogger<ClientApiCaller> logger)
    {
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            _logger.LogError(ex, "Falha ao chamar endpoint {RelativePath} no portal cliente.", relativePath);
