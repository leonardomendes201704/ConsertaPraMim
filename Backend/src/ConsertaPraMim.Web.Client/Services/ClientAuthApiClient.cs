...
public class ClientAuthApiClient : IClientAuthApiClient
{
    private static readonly JsonSerializerOptions JsonOptions = new(JsonSerializerDefaults.Web);

    private readonly IHttpClientFactory _httpClientFactory;
    private readonly IConfiguration _configuration;
    private readonly ILogger<ClientAuthApiClient> _logger;

    public ClientAuthApiClient(
        IHttpClientFactory httpClientFactory,
        IConfiguration configuration,
        ILogger<ClientAuthApiClient> logger)
    {
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            _logger.LogError(ex, "Falha ao chamar API de autenticacao do portal cliente.");
